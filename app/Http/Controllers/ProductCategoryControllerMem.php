...
class ProductCategoryControllerMem extends Controller
{
    /**
    ...
    public function index(ProductCategory $model)
    {
        ...
        return view('inventory.categories.indexMem', compact('categories'));
    }
    ...
    {
        return view('inventory.categories.createMem');
    }
    ...
    {
        return view('inventory.categories.showMem', [
            'category' => $category,
    ...
    {
        return view('inventory.categories.editMem', compact('category'));
    }
