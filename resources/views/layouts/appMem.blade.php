...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="white-content {{ $class ?? '' }}">
        @auth()
            <div class="wrapper">
                    @include('layouts.navbars.sidebarMem')
        ...
        <script>
            $(document).ready(function() {
                $().ready(function() {
                    ...
                    fixed_plugin_open = $('.sidebarMem .sidebar-wrapper .nav li.active a p').html();
                    ...
                    $('.switch-sidebarMem-mini input').on("switchChange.bootstrapSwitch", function() {
                        var $btn = $(this);

                        if (sidebar_mini_active == true) {
                            $('body').removeClass('sidebarMem-mini');
                            sidebar_mini_active = false;
                            whiteDashboard.showSidebarMessage('Sidebar mini deactivated...');
                        } else {
                            $('body').addClass('sidebarMem-mini');
                            sidebar_mini_active = true;
